        ...
        <div className="card">
            <div className="img" id="imgoo">
                <Link to={`/${props.sp}/${props.data.id}`}>
                    <img id="imgTo" src={props.data.image1} alt />
                </Link>
            </div>
            ...
            <div className="type">
                <img id="imgNho1" src={props.data.image2} onMouseEnter = {onRepalace} onMouseLeave = {resetImg}  alt />
                <img id="imgNho2" src={props.data.image3} onMouseEnter = {onRepalace.bind(this, 1, 0, props.data.image3)} onMouseLeave = {resetImg} alt />
            </div>
